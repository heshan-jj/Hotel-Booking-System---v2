...
export function Sidebar() {
  ...
  return (
    <aside className="flex h-screen w-64 flex-col border-r border-black/[0.06] dark:border-white/[0.08] bg-white/80 dark:bg-zinc-950/80 backdrop-blur-xl select-none">
      {/* Brand Header */}
      <div className="flex h-14 items-center gap-3 border-b border-black/[0.05] dark:border-white/[0.06] px-4">
        {settings?.logo_url ? (
